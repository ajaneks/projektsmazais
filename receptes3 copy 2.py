...
class RecipeApp(tk.Tk):
    def __init__(self):
        ...
        self.home_button = ctk.CTkButton(self.side_buttons, text="Home", command=lambda: self.notebook.select(self.tab1),
                                         bg_color="#2b2b2b", hover_color="#1e1e1e", corner_radius=5)
        self.home_button.pack(fill="x", padx=5, pady=5)
        self.home_button.style.configure("CTkButton", foreground="black")
        ...
        self.ingredient_check_button.style.configure("CTkButton", foreground="black")
        ...
        self.add_recipe_button.style.configure("CTkButton", foreground="black")
